...
public class BanjixiangceLiuyanView extends BanjixiangceLiuyanEntity implements Serializable {
	...
	public BanjixiangceLiuyanView() {

	}

	public BanjixiangceLiuyanView(BanjixiangceLiuyanEntity banjixiangceLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, banjixiangceLiuyanEntity);
