...
//                            yonghuEntity.setYonghuQq(data.get(0));                    //QQ 要改的
//                            yonghuEntity.setYonghuWeixin(data.get(0));                    //微信 要改的
//                            yonghuEntity.setSexTypes(Integer.valueOf(data.get(0)));   //性别 要改的
//                            yonghuEntity.setNianling(Integer.valueOf(data.get(0)));   //年龄 要改的
//                            yonghuEntity.setYonghuText(data.get(0));                    //其他信息 要改的
